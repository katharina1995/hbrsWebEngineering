...
<p>${this.time}</p>
 ...
 customElements.define('my-stoppuhr', MyStoppuhr);
  ...
  <!-- css des folgendes Moduls (grow, grow:hover) aus folgender Quelle: https://css-tricks.com/snippets/css/scale-on-hover-with-webkit-transition/ (zuletzt besucht am 12.07.2020) -->
  <script type="module">
